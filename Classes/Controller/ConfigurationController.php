...
class ConfigurationController extends \TYPO3\CMS\Extbase\Mvc\Controller\ActionController {
	 ...
	 *
	 * @var \S3b0\EcomConfigCodeGenerator\Domain\Repository\ConfigurationRepository
	 * @inject
	 */
	 ...
	 * @return void
	 */
	public function showAction(\S3b0\EcomConfigCodeGenerator\Domain\Model\Configuration $configuration) {
